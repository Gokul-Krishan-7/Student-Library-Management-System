...
public class BorrowBookData {
	...
	public BorrowBookData() {
	super();
	}
	
	public BorrowBookData(int bk_Id,String bk_IdNo, String bk_Name, String bk_Author, String st_Name,
			String st_IdNo,String bk_Quanty,String st_ContactNo,String date_Time) {
		super();
		this.bk_Id = bk_Id;
	...
	public BorrowBookData(int bk_Id,String bk_IdNo, String bk_Name, String bk_Author) {
		super();
		this.bk_Id = bk_Id;
		this.bk_IdNo = bk_IdNo;
		this.bk_Name = bk_Name;
